...
# grok-4-fast-non-reasoning trades a little patch precision for noticeably
# faster responses and lower cost — good default for interactive Marco use.
# Flip to grok-4-fast-reasoning via XAI_MODEL when patch-heavy work needs it.
